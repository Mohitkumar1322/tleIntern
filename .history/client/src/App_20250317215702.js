...
function App() {
  ...
  // Replace your existing useEffect with this new version
  useEffect(() => {
    ...
    fetchData();
  }, [showBookmarked]); // Changed from [fetchContests] to [showBookmarked]
  ...
  useEffect(() => {
    fetchContests();
  }, [fetchContests]);  // Re-fetch when showBookmarked changes
